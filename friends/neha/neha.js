...
const friendData = {
    name: "Neha",
    nickname: "Jehrilliiiiiii!",
    emoji: "🍷",
    photo: "profile.jpg",
    birthday: "March 30",
    zodiac: "🐍",
    superpower: "Dramebaaz & Funny girl ",
    pyaar: "kushhhhhh",
    moodEmoji: "🤪",
    primaryColor: "#ff6b6b",
    ...
    memories: {
        ...
        funnyMoment: "Staircase, tere gharpe , garden area , ehsaas , readingroom and many places",
        photo: "card.jpg",
        insideJoke: "don't say cheese...say NEHAHAHAHA *wink*"
    },
    funFacts: {
        weirdHabit: "gyaani baba😂",
        catchphrase: "NEHAHA...😭",
        animal: "u would be peacock🦚"
    },
    awards: [
        "Dramebaaz",
        "Award for Extrovert girl",
        "Swarma lover!"
    ],
    ...
    game: {
        correctAnswer: "aagya daala!",
        options: [
            "jo jale side se chale!",
            "vivek ki bandi aayi !",
            "aagya daala!"
        ]
    }
