...
const friendData = {
    name: "pradnya",
    nickname: "pradnyaaaaaaaaaa!",
    emoji: "👧",
    photo: "profile.jpg",
    birthday: "Feb 10",
    zodiac: "🐍",
    superpower: "Cutiee & book reader",
    pyaar: "suraj ya wo uska naam bata du?",
    moodEmoji: "🤪",
    primaryColor: "#ff6b6b",
    ...
    memories: {
        ...
        photo: "card.jpg",
        insideJoke: "Merse jhagda ki but maine mana liya tha😎😂 *wink*"
    },
    funFacts: {
        weirdHabit: "tu khud puri hai😂",
        catchphrase: "mai toh aisi hi hu😭",
        animal: "u would be female fox🦝"
    },
    awards: [
        "Book reading!",
        "Award for Being cutie!",
        "Suraj lover!"
    ],
    ...
    game: {
        correctAnswer: "suraj mera bf hai!",
        options: [
            "suraj yeda hai!",
            "suraj idiot hai!",
            "suraj mera bf hai!"
