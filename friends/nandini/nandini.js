...
const friendData = {
    name: "Nandini",
    nickname: "Meri pyari Nachos!",
    emoji: "👧",
    photo: "profile.jpg",
    birthday: "May 15",
    zodiac: "🐍",
    superpower: "10 pointers, stupidity & jokes",
    mood: "dance",
    moodEmoji: "🤪",
    primaryColor: "#ff6b6b",
    ...
    accentColor: "#ffe66d",
    memories: {
        howWeMet: "Muje yaad toh nahii....but sayad hum reading room mai mile the🙂",
        funnyMoment: "apna toh rozz ka tha phone calls ho ya meeting har moment funny hi hota!!",
        photo: "card.jpg",
        insideJoke: "YOU : Same shit!! ME : I got you nachos😂 *wink*"
    },
    funFacts: {
        weirdHabit: "You dance like u r in pub😂",
        catchphrase: "Nachos meri behen hai...😭",
        animal: "u would be cat (wo bhi aalsi wali)"
    },
    awards: [
        "Award for best behen",
        "Medal for Best study partner",
        "Panipuri partner"
    ],
    ...
    game: {
        correctAnswer: "Ayyee marungi na ...chup",
        options: [
            "That's what she said!",
            "Ayyee marungi na ...chup",
...
function getTrophyIcon(award) {
    if (award.includes("Medal")) return "🥇";
    if (award.includes("sh")) return "🌙";
    if (award.includes("partner")) return "🍕";
    return "🏆";
}
