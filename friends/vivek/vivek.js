...
const friendData = {
    name: "vivek",
    nickname: "chotta Jaishankar!",
    emoji: "👓",
    photo: "profile.jpg",
    birthday: "feb 21",
    zodiac: "🐍",
    superpower: "Idiot, Autocorrection & Chiknaaaaa!",
    pyaar: "chai aur sath chai peenewali",
    moodEmoji: "🤪",
    primaryColor: "#ff6b6b",
    secondaryColor: "#ca2f2f",
    accentColor: "#ffe66d",
    memories: {
        howWeMet: "BEST bus, yaad hai hum sab ek sath the last seat pe baithe the🥺 humne selfie bhi li thi😂💓",
        funnyMoment: "Staircase, mere gharpe , garden area ,tiffin, ehsaas , readingroom and many places",
        photo: "card.jpg",
        insideJoke: "baniyan gang ka owner hai tu😂 *wink*"
    },
    funFacts: {
        weirdHabit: "chalta firta auto-correct😂",
        catchphrase: "deadshot hack krliya😭",
        animal: "u would be squirel🐿️"
    },
    awards: [
        "medal for correcting me!",
        "Award for buying chai!",
        "Swarma lover!"
    ],
    ...
    game: {
        correctAnswer: "bhai..bus depot jaunga mai toh!",
        options: [
            "tera katega!",
            "mai toh single hu!",
            "bhai..bus depot jaunga mai toh!"
        ]
    }
};
...
function getTrophyIcon(award) {
    ...
    if (award.includes("lover")) return "🍕";
    return "🏆";
}
