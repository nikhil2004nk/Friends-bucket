...
const friendData = {
    ...
    birthday: "Jan 01",
    zodiac: "♐",
    superpower: "Making bad jokes sound good",
    mood: "Chill",
    moodEmoji: "😎",
    ...
    memories: {
        howWeMet: "That time you tripped over your own shoelaces in the cafeteria and I was the only one who laughed WITH you",
        funnyMoment: "When we tried to cook pasta at 3AM and nearly set off the fire alarm",
        photo: "card.jpg",
        insideJoke: "Pineapple DOES belong on pizza, fight me!"
    },
    funFacts: {
        weirdHabit: "Talks to plants when he thinks no one's watching",
        catchphrase: "Bruh moment",
        animal: "A golden retriever (loyal but easily distracted)"
    },
    awards: [
    ...
    quote: "If at first you don't succeed, blame it on the WiFi",
    social: {
    ...
    status: "Pretending to work while actually watching memes",
    game: {
        correctAnswer: "The Great Ketchup Incident",
        options: [
            "That time with the thing",
            "The Great Ketchup Incident",
    ...
    return `
            ...
            <div class="profile-info">
                ...
                <div class="profile-grid">
                    ...
                    <div class="profile-item">
                        ...
                        <span id="mood">${friendData.mood}</span>
        ...
        <section class="social-zone">
            ...
            <div class="social-icons">
                ...
                <a href="${friendData.social.twitter}" class="social-icon pulse" id="twitter">🐦</a>
            </div>
...
function getTrophyIcon(award) {
    if (award.includes("Most Likely")) return "😴";
    if (award.includes("Impersonations")) return "🎭";
    if (award.includes("Dad Jokes")) return "👨";
    return "🏆";
}
    ...
    buttons.forEach(button => {
        button.addEventListener('click', function () {
            if (this.dataset.answer === 'correct') {
                ...
                setTimeout(() => {
                    feedback.innerHTML += `<div class="hidden-message">You're the best! Here's a secret: <em>${friendData.name} loves you!</em></div>`;
                }, 1000);
            } else {
