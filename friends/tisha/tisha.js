...
const friendData = {
    ...
    accentColor: "#ffe66d",
    memories: {
        howWeMet: "lecs mai mile the hum aage peeche baithe the, yaad hai masa masi ka role de rhi thi tu something😂💓",
        funnyMoment: "lecs, tere gharpe, garden area, Games, readingroom and many places",
        photo: "card.jpg",
        insideJoke: "Tisuuuuuuuu chalna wo reel banate *wink*"
    },
    funFacts: {
        weirdHabit: "Badbad krne wali ladki😂",
        catchphrase: "Tisuuu Tisuuu Tissuuu...😭",
        animal: "u would be swan🦢"
    },
    awards: [
        "Award for Gussaaaa krna",
        "chal padhte hai!",
        "korean burger!"
    ],
    ...
    game: {
        correctAnswer: "chal....chal...chal!",
        options: [
            "idiot hai tu!",
            "mujse kyu baat krega!",
            "chal....chal...chal!"
        ]
    }
};
