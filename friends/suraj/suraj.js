...
const friendData = {
    name: "suraj",
    nickname: "surajvaaaaaaaaa!",
    emoji: "😎",
    photo: "profile.jpg",
    birthday: "Jan 01",
    zodiac: "🐍",
    superpower: "Topper & smarty ",
    pyaar: "Pradnya ya wo uska naam bata du?",
    moodEmoji: "🤪",
    primaryColor: "#ff6b6b",
    ...
    memories: {
        ...
        funnyMoment: "Staircase, tere gharpe, garden area, lecs, exam time, readingroom and many places",
        photo: "card.jpg",
        insideJoke: "2 teri 2 meri😂🙊 *wink*"
    },
    funFacts: {
        weirdHabit: "sab krna hota hai launde ko😂",
        catchphrase: "pradnya ko mat batana😭",
        animal: "u would be fox🦊"
    },
    awards: [
        "Topping class!",
        "Award for writting stories in exam!",
        "pradnya lover!"
    ],
    ...
    game: {
        correctAnswer: "Pradnya ko miss kr rha!",
        options: [
            "pradnya ko bhi bhej dena!",
            "Pradnya ko bhi include kro!",
            "Pradnya ko miss kr rha!"
        ]
    }
};
