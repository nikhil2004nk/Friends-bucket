const friendData = {
    ...
    birthday: "march 10",
    zodiac: "🐍",
    superpower: "Masoom & kind hearted!",
    pyaar: "sabka naam bata du?!",
    moodEmoji: "🤪",
    primaryColor: "#ff6b6b",
    secondaryColor: "#ca2f2f",
    accentColor: "#ffe66d",
    memories: {
        howWeMet: "muje exactly yaad nhi sayad hum lec mao mile the aur uske baad staircase pe mile the...tiffin ne bana di jodii😂💓",
        funnyMoment: "Staircase, lecs after lec, tiffin, mahindra wali walk, garden area, readingroom and many places",
        photo: "card.jpg",
        insideJoke: "flat pasand hai ?😂 *wink*"
    },
    funFacts: {
        weirdHabit: "Bohot badbad krta😂",
        catchphrase: "Mai hi sabko bura lagta😭",
        animal: "u would be cow🐄(magar beard wala😂)"
    },
    awards: [
        "Award for Masoomiyat",
        "pyara singer",
        "samosa khane chalo!"
    ],
    ...
    game: {
        correctAnswer: "Maine toh kuch kiya bhi nhi!",
        options: [
            "Jayesh aur shubham muje pareshan krte!",
            "Maine toh kuch kiya bhi nhi!",
            "Aaj tiffin nhi laya!"
        ]
    }
};
