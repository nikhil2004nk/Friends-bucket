...
const friendData = {
    ...
    birthday: "Nov 11",
    zodiac: "🐍",
    superpower: "Idiot, dancer & funny!",
    pyaar: "kitno ka naam batau ab🙂",
    moodEmoji: "🤪",
    primaryColor: "#ff6b6b",
    secondaryColor: "#ca2f2f",
    accentColor: "#ffe66d",
    memories: {
        howWeMet: "muje toh exactly yaad nhi ...magar kahi bhi mile ho tu lucky hai jo mai mila tuje😂💓",
        funnyMoment: "Staircase, mere gharpe , garden area , ehsaas , readingroom and many places",
        photo: "card.jpg",
        insideJoke: "Paani lete jaana diva mai miss kregi😂 *wink*"
    },
    funFacts: {
        weirdHabit: "koi weird habbit nhi tu hai😂",
        catchphrase: "ek mai hi tera side leti hu...tu mujse hi pange le rha😭",
        animal: "u would be unicorn🦄"
    },
    awards: [
        "medal for supporting me!",
        "Award for motivating me!",
        "Swarma lover!"
    ],
    ...
    game: {
        correctAnswer: "vivek ki bandi aayi !",
        options: [
            "tera kaatega!",
            "vivek ki bandi aayi !",
            "aagya daala!"
