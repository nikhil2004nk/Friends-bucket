...
const friendData = {
    name: "palak",
    nickname: "pulak looser!",
    emoji: "🐼",
    photo: "profile.jpg",
    birthday: "March 9",
    zodiac: "🐍",
    superpower: "Dramebaaz & cutieee",
    pyaar: "mai ofc😂",
    moodEmoji: "🤪",
    primaryColor: "#ff6b6b",
    ...
    accentColor: "#ffe66d",
    memories: {
        howWeMet: "lecs mai mile the hum muje toh exactly yaad nhi ...magar kahi bhi mile ho tu lucky hai jo mai mila tuje😂💓",
        funnyMoment: "lecs, garden area, Games, readingroom, dance practice and many places",
        photo: "card.jpg",
        insideJoke: "pulak tu single thodi hai mai huna!!😂 *wink*"
    },
    funFacts: {
        weirdHabit: "Nikhil ko nikil bolne wali😂",
        catchphrase: "Doremon hai tu meri😭",
        animal: "u would be monkey🙊"
    },
    awards: [
        "For Best dancer",
        "Medal for Having best eyes!",
        "Cheese pizza!"
    ],
    ...
    game: {
        correctAnswer: "Nikil Nikil Nikil!",
        options: [
            "Nikil Nikil Nikil!",
            "tu notes nhi bheja!",
            "Mere sath reel bana!"
...
function getTrophyIcon(award) {
    if (award.includes("for")) return "🥇";
    if (award.includes("a")) return "🌙";
    if (award.includes("korean")) return "🍕";
    return "🏆";
}
